...
int CPnxml::PN_Xml_Init()
{
	...
	printf("*******************devid == %s*************************\n",devid_get);
	sprintf(onlin_url,"101.69.255.131:9000/Dev/devOnline?devId=%s",devid_get);
	printf("***onlin_url == %s****\n",onlin_url);
...
/*********tcp*************/
           else if(strncmp(cmd_tmp,"./tcpc",6)==0 || strncmp(cmd_tmp,"./tcps",6)==0||strncmp(cmd_tmp,"./udpc",6)==0 || strncmp(cmd_tmp,"./udps",6)==0){
